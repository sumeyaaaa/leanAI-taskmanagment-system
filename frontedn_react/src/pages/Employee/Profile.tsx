...
const Profile: React.FC = () => {
  ...
  const handleSaveDescription = async () => {
    ...
    try {
      console.log('[Profile] Saving description:', description);
      ...
      if (result && result.id) {
        ...
        console.error('[Profile] Update failed: Invalid result', result);
        alert('Failed to save description. Please try again.');
      }
    } catch (error: any) {
      console.error('[Profile] Error saving description:', error);
